...
MZ_EXPORT int32_t mz_zip_entry_write_open(void *handle, const mz_zip_file *file_info, \
...
MZ_EXPORT int32_t mz_zip_extrafield_contains(const uint8_t *extrafield, int32_t extrafield_size, \
