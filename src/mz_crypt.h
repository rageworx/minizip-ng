...
MZ_EXPORT int32_t  mz_crypt_pbkdf2(uint8_t *password, int32_t password_length, uint8_t *salt, \
...
MZ_EXPORT int32_t  mz_crypt_aes_decrypt_final(void *handle, uint8_t *buf, int32_t size, const uint8_t *tag, int32_t tag_size);
MZ_EXPORT int32_t  mz_crypt_aes_set_encrypt_key(void *handle, const void *key, int32_t key_length, \
                                                const void *iv, int32_t iv_length);
MZ_EXPORT int32_t  mz_crypt_aes_set_decrypt_key(void *handle, const void *key, int32_t key_length, \
                                                const void *iv, int32_t iv_length);
